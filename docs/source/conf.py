...
latex_documents = [
    (master_doc, 'RFEM.tex', 'RFEM Documentation',
     'Dlubal Software', 'manual'),
]
...
man_pages = [
    (master_doc, 'rfem', 'RFEM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RFEM', 'RFEM Documentation',
     author, 'RFEM', 'One line description of project.',
     'Miscellaneous'),
]
